...
data_files_spec = [
    (
        "share/jupyter/nbextensions/deephaven_ipywidgets",
        "deephaven_ipywidgets/nbextension",
        "**",
    ),
    (
        "share/jupyter/labextensions/@deephaven/ipywidgets",
        "deephaven_ipywidgets/labextension",
        "**",
    ),
